...
const Form = (props) => {
    ...
    const handleSearch = e => {
        let baseURL = `https://api.adzuna.com/v1/api/jobs/us/search/1?results_per_page=5&app_id=${process.env.REACT_APP_ADZUNA_APPID}&app_key=${process.env.REACT_APP_ADZUNA_KEY}`;
